...
if(isset($_POST['token'])) {
    ...
    $token = $_POST['token'];
    $idAccount = $_POST['id'];
    $timezone = $_POST['timezone']; // Retrieve the timezone from the form
...
//    if ($idAccount > 1000000000000) {
        ...
        $db->execute("INSERT INTO `tokens`(`name`, `token`, `id_ad_account`, `csrf`, `sessionid_ss_ads`, `timezone`) VALUES ('".$getStatus['data']['name']."', '$token','$idAccount','$csrfToken','$sessionid_ss_ads', '$timezone')");
